...
import { BottomLine, BackgroundCircles, Gradient } from './design/Hero'
        ...
        <Section className='pt-[12rem] -mt-[5.25rem]' crosses crossesOffset='lg:translate-y-[5.25rem]'
            ...
            <div className='container relative' ref={parallaxRef}>
                <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]'>
                    ...
                    <p className='body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:m-8'>
                ...
                <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
                    ...
                    <div className='absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104%]'>
                        <img src={heroBackground} alt="robot" className='w-full' width={1440} height={1800} />
                    </div>
                    <BackgroundCircles />
                </div>
