            ...
            <div className='container'>
                ...
                <div className='relative'>
                    <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10
                        ...
                        <div className='ml-auto relative z-1 max-w-[17rem]'>
                    ...
                    <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                        ...
                        <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                            ...
                            <div className='relative h-[22rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]'>
                                <img src={service3} alt="col robot" width={520} height={400} className='w-full h-full object-cover' />
                                <VideoChatMessage/>
                                <VideoBar/>
                            </div>
                        </div>
